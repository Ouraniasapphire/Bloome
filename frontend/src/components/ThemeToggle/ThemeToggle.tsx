...
export default function ThemeToggle() {
    ...
    const Sun = () => (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 -960 960 960' class='h-3 w-3 fill-white'>
    ...
    return (
        <label class='flex cursor-pointer select-none items-center '>
            <div class='relative '>
                ...
                {/* Track */}
                <div class='block h-6 w-12 rounded-full transition-colors duration-300 border-gray-200 bg-white  border-2 dark:bg-blue-600 dark:border-transparent'></div>
