...
const TempCourseCard: Component<CourseCardProps> = (props) => {
...
const CourseCard: Component<CourseCardProps> = (props) => {
    ...
    return (
        <div class='flex flex-col md:flex-row gap-4 rounded-2xl p-4 shadow-xl border-2 border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700 w-full max-w-md md:max-w-3xl mx-auto'>
            {/* Color block / Hero image */}
            ...
            <div class='flex flex-col justify-between flex-1'>
                <div>
                    <h1 class='text-xl md:text-2xl font-extrabold mb-1 text-gray-800 dark:text-gray-100'>
                        {props.name}
                    </h1>
                ...
                <div class='flex flex-col sm:flex-row gap-2 mt-4'>
                    <button
                        class='flex-1 rounded-lg bg-gradient-to-b from-blue-600 to-purple-600 px-4 py-2 text-lg font-semibold text-gray-100 transition-colors hover:from-blue-700 hover:to-purple-700'
                        onClick={goToStudio}
                    >
                        View Studio
                    </button>
                    <button class='rounded-lg border-2 border-gray-200 px-4 py-2 text-lg font-semibold text-gray-800 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800'>
                        ⚙️
                    </button>
                </div>
            </div>
